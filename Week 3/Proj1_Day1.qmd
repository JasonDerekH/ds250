...
Instead of filtering my dataset, I can change the years shown on the fly, in the plot

```{python}
(
    ggplot(data = usa, mapping = aes(x = "Year", y= "Life")) +
    geom_line() +
...
# Scale x continuous for removing commas in x-axis
